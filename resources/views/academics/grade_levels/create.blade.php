...
<div class="flex justify-center px-4 py-8">
    <div class="w-full max-w-2xl bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
        ...
        <div class="mb-8 text-center">
            ...
            <p class="text-gray-600 text-base">Lengkapi formulir di bawah ini untuk membuat kelas baru.</p>
        </div>
        ...
        <form action="{{ route('academic.grade-levels.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" name="grade" id="grade"
                           class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-base shadow-sm placeholder-gray-400
                                  focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 outline-none"
                           value="{{ old('grade') }}" min="1" max="20" required placeholder="Contoh: 7 (Untuk kelas 7)">
                ...
                <div>
                    ...
                    <input type="text" name="label" id="label"
                           class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-base shadow-sm placeholder-gray-400
                                  focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 outline-none"
                           value="{{ old('label') }}" placeholder="Contoh: 7A, 7B, X-IPA" required>
            ...
            <div class="mb-5">
                ...
                <textarea name="description" id="description" rows="4"
                          class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-base shadow-sm placeholder-gray-400
                                 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 outline-none"
                          placeholder="Contoh: Kelas 7 untuk jenjang SMP Al-Bahjah">{{ old('description') }}</textarea>
            ...
            <div class="flex items-center mb-6">
                ...
                <label for="is_active" class="ml-2 text-base text-gray-700 select-none">Aktif</label>
