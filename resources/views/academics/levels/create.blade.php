...
<div class="flex justify-center px-4 py-8">
    <div class="w-full max-w-3xl bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
        ...
        <div class="mb-8 text-center">
            ...
            <p class="text-gray-600 text-base">Lengkapi formulir di bawah ini untuk membuat jenjang pendidikan baru.</p>
        </div>
        ...
        <form method="POST" action="{{ route('academic.levels.store') }}" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="min_grade" id="min_grade" value="{{ old('min_grade') }}"
                           class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-base shadow-sm placeholder-gray-400
                                  focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 outline-none"
                ...
                <div>
                    ...
                    <input type="number" name="max_grade" id="max_grade" value="{{ old('max_grade') }}"
                           class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-base shadow-sm placeholder-gray-400
                                  focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 outline-none"
            ...
            <div class="mb-6">
                ...
                <textarea name="description" id="description" rows="4"
                          class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-base shadow-sm placeholder-gray-400
                                 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 outline-none"
                          placeholder="Deskripsi tambahan tentang jenjang ini...">{{ old('description') }}</textarea>
