...
@section('content')
<div class="mb-6">
  <h2 class="text-2xl font-bold text-blue-700">Tambah Data Staff</h2>
  <p class="text-sm text-gray-500">Isi informasi lengkap staff.</p>
</div>

<form action="{{ route('employee.staffs.store') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow rounded-xl p-6 space-y-4">
  @csrf
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div>
      ...
      <input type="text" name="employment_status" value="{{ old('employment_status') }}" class="form-input w-full" placeholder="Tetap / Honorer / Kontrak" />
    </div>
