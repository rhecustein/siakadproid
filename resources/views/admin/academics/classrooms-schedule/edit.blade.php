...
@section('content')
<div class="mb-6">
  <h2 class="text-2xl font-bold text-blue-700">Edit Classroom</h2>
  <p class="text-sm text-gray-500">Update classroom data below.</p>
</div>

<form action="{{ route('academic.classrooms-schedule.update', $classroom) }}" method="POST" class="bg-white shadow rounded-xl p-6 space-y-6">
  @csrf
  @method('PUT')
