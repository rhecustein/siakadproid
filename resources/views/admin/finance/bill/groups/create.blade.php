...
<div class="mb-8">
    <h1 class="text-3xl lg:text-4xl font-extrabold text-gray-900 mb-2 tracking-tight">
        Tambah Grup Tagihan Baru
    </h1>
    <p class="text-gray-600 text-base">Buat kelompok tagihan untuk memudahkan pengelolaan pembayaran siswa secara masal.</p>
</div>
...
<div class="bg-white shadow-xl rounded-2xl p-8 mb-8 border border-gray-100">
    <form action="{{ route('finance.bill-groups.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
                ...
                <input type="number" name="tagihan_count" id="tagihan_count" value="{{ old('tagihan_count') }}"
                       class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm py-2.5 px-4 transition-all duration-200"
            ...
            <div>
                ...
                <input type="number" name="amount_per_tagihan" id="amount_per_tagihan" value="{{ old('amount_per_tagihan') }}"
                       class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm py-2.5 px-4 transition-all duration-200"
        ...
        <div>
            ...
            <textarea name="description" id="description" rows="3"
                      class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm py-2.5 px-4 transition-all duration-200"
                      placeholder="Penjelasan singkat mengenai grup tagihan ini.">{{ old('description') }}</textarea>
        ...
        <div>
            <div class="flex items-center mt-4">
                <input type="checkbox" name="is_active" id="is_active" value="1"
                       ...
                       {{ old('is_active', true) ? 'checked' : '' }}> {{-- Default to active --}}
        ...
        <div class="flex justify-end items-center gap-4 pt-4">
            ...
            <button type="submit"
                ...
                <i class="fas fa-save mr-2"></i> Simpan Grup Tagihan
            </button>
        </div>
    </form>
</div>
