...
<div class="mb-8">
    ...
    <p class="text-gray-600 text-base">Isi detail barang inventaris baru untuk sistem.</p>
</div>
...
<div class="bg-white shadow-xl rounded-2xl p-8 mb-8 border border-gray-100">
    <form method="POST" action="{{ route('facility.inventories.store') }}" class="space-y-6">
        @csrf
        ...
        <div>
            ...
            <textarea name="description" id="description" rows="3"
                      class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm py-2.5 px-4 transition-all duration-200"
                      placeholder="Detail spesifik tentang barang ini, misal: 'Proyektor multimedia XGA, 3000 lumens'">{{ old('description') }}</textarea>
        ...
        <div class="border-t border-gray-200 pt-6 mt-6">
            ...
            <div>
                ...
                <textarea name="notes" id="notes" rows="3"
                          class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm py-2.5 px-4 transition-all duration-200"
                          placeholder="Catatan khusus tentang inventaris ini">{{ old('notes') }}</textarea>
