...
<div class="mb-8">
    <h1 class="text-3xl lg:text-4xl font-extrabold text-gray-900 mb-2 tracking-tight">
        Edit Tipe Inventaris
    </h1>
    <p class="text-gray-600 text-base">Perbarui detail jenis inventaris ini.</p>
</div>
...
<div class="bg-white shadow-xl rounded-2xl p-8 mb-8 border border-gray-100">
    <form method="POST" action="{{ route('facility.inventory-types.update', $inventoryType->id) }}" class="space-y-6">
        @csrf
        @method('PUT')

        <div>
            <label for="name" class="block text-sm font-semibold text-gray-800 mb-1">Nama Tipe <span class="text-red-500">*</span></label>
            <input type="text" name="name" id="name" value="{{ old('name', $inventoryType->name) }}"
                   ...
                   placeholder="Contoh: Elektronik, Furniture" required autofocus>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div class="flex items-center">
                <input type="checkbox" name="is_consumable" id="is_consumable" value="1"
                       class="form-checkbox h-5 w-5 text-blue-600 rounded border-gray-300 focus:ring-blue-500"
                       {{ old('is_consumable', $inventoryType->is_consumable) ? 'checked' : '' }}>
        ...
        <div>
            ...
            <input type="number" name="economic_life" id="economic_life" value="{{ old('economic_life', $inventoryType->economic_life) }}"
                   class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm py-2.5 px-4 transition-all duration-200"
        ...
        <div class="flex justify-end items-center gap-4 pt-4">
            ...
            <button type="submit"
                ...
                <i class="fas fa-save mr-2"></i> Perbarui Tipe Inventaris
            </button>
        </div>
    </form>
</div>
