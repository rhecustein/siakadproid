...
<div class="max-w-xl mx-auto p-6">
    <div class="bg-white shadow-md rounded-xl p-6 space-y-6">
        ...
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-bold text-blue-700">➕ Tambah Tipe Inventaris</h2>
        ...
        <form method="POST" action="{{ route('facility.inventory-types.store') }}" class="space-y-5">
            @csrf
