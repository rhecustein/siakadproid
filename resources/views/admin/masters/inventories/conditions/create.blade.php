...
<div class="max-w-xl mx-auto p-6">
    <div class="bg-white shadow-md rounded-xl p-6 space-y-6">
        ...
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-bold text-blue-700">➕ Tambah Kondisi Inventaris</h2>
        ...
        <form method="POST" action="{{ route('facility.inventory-conditions.store') }}" class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}"
                       ...
                       required placeholder="Contoh: Baik, Rusak Ringan, Rusak Berat">
                @error('name')
            ...
            <div>
                ...
                <textarea name="description" rows="4"
                          ...
                          placeholder="Penjelasan lebih detail...">{{ old('description') }}</textarea>
                @error('description')
                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                @enderror
            </div>
