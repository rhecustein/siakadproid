...
@section('content')
  <div class="mb-6">
    <h2 class="text-2xl font-bold text-blue-700">Tambah Tahun Ajaran</h2>
    <p class="text-sm text-gray-500">Masukkan informasi tahun ajaran baru.</p>
  </div>

  <div class="bg-white shadow rounded-xl p-6">
    <form action="{{ route('academic.academic-years.store') }}" method="POST" class="space-y-6">
      @csrf
