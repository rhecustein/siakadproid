...
<div class="mb-8">
    <h1 class="text-3xl lg:text-4xl font-extrabold text-gray-900 mb-2 tracking-tight">
        Edit Penugasan Wali Kelas
    </h1>
    <p class="text-gray-600 text-base">Perbarui guru, kelas, atau tahun ajaran pada penugasan ini.</p>
</div>
...
<div class="bg-white shadow-xl rounded-2xl p-8 mb-8 border border-gray-100">
    <form action="{{ route('academic.homeroom.update', $homeroom->id) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div>
            <label class="block text-sm font-semibold text-gray-800 mb-1">Status Penugasan</label>
            <div class="mt-1 flex items-center space-x-4">
                <label for="is_active_true" class="inline-flex items-center">
                    <input type="radio" id="is_active_true" name="is_active" value="1"
                           ...
                           {{ old('is_active', $homeroom->is_active) == 1 ? 'checked' : '' }}>
                ...
                <label for="is_active_false" class="inline-flex items-center">
                    <input type="radio" id="is_active_false" name="is_active" value="0"
                           ...
                           {{ old('is_active', $homeroom->is_active) == 0 ? 'checked' : '' }}>
