...
@section('content')
  <div class="mb-6">
    <h2 class="text-2xl font-bold text-blue-700">Tambah Ruangan Kelas</h2>
    <p class="text-sm text-gray-500">Masukkan detail kelas, tahun ajaran, dan jenjang pendidikan.</p>
  </div>

  <div class="bg-white shadow rounded-xl p-6">
    <form action="{{ route('academic.classrooms.store') }}" method="POST" class="space-y-6">
      @csrf
      ...
      <div>
        ...
        <input type="text" name="room" id="room"
               value="{{ old('room') }}"
               class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm sm:text-sm"
               placeholder="Contoh: Lab Fisika / R.201">
      </div>
      ...
      <div class="flex justify-between items-center">
        <a href="{{ route('academic.classrooms.index') }}" class="text-sm text-gray-600 hover:underline">← Kembali</a>
        <button type="submit"
