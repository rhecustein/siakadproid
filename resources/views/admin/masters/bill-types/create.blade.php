{{-- resources/views/admin/masters/bill-types/form.blade.php (Anda bisa buat satu file ini dan panggil dari create.blade.php dan edit.blade.php) --}}
{{-- Jika Anda ingin tetap dua file terpisah, cukup salin konten ini ke keduanya --}}
...
<div class="mb-8">
    <h1 class="text-3xl lg:text-4xl font-extrabold text-gray-900 mb-2 tracking-tight">
        {{ isset($billType) ? 'Edit Tipe Tagihan' : 'Tambah Tipe Tagihan Baru' }}
    </h1>
    <p class="text-gray-600 text-base">
        {{ isset($billType) ? 'Perbarui detail untuk tipe tagihan ini.' : 'Isi detail tipe tagihan baru untuk layanan keuangan sekolah.' }}
    </p>
</div>
...
<div class="bg-white shadow-xl rounded-2xl p-8 mb-8 border border-gray-100">
    <form method="POST"
        ...
        <div class="border-t border-gray-200 pt-6 mt-6">
            ...
            {{-- Tambahkan error display untuk is_online_payment dan is_monthly jika ada kebutuhan --}}
            ...
            <div class="flex items-center space-x-4">
                ...
                <label for="is_active_false" class="inline-flex items-center">
                    <input type="radio" id="is_active_false" name="is_active" value="0"
                           ...
                           {{ old('is_active', $billType->is_active ?? true) == 0 ? 'checked' : '' }}>
        ...
        <div class="flex justify-end items-center gap-4 pt-4">
            ...
            <button type="submit"
                ...
                <i class="fas fa-save mr-2"></i> {{ isset($billType) ? 'Perbarui' : 'Simpan' }} Tipe Tagihan
            </button>
        </div>
    </form>
</div>
