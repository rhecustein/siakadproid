...
@section('content')
  <div class="mb-6">
    <h2 class="text-2xl font-bold text-blue-700">Tambah Guru</h2>
    <p class="text-sm text-gray-500">Masukkan data lengkap guru untuk dihubungkan ke sekolah dan login pengguna.</p>
  </div>
  ...
  <div class="bg-white shadow rounded-xl p-6">
    <form action="{{ route('academic.teachers.store') }}" method="POST" class="space-y-6">
      ...
      <div class="flex justify-between items-center">
        <a href="{{ route('academic.teachers.index') }}" class="text-sm text-gray-600 hover:underline">← Kembali</a>
        <button type="submit"
