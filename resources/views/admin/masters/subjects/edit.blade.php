...
<div class="flex justify-center px-4 py-8">
    <div class="w-full max-w-2xl bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
        ...
        <div class="mb-8 text-center">
            ...
            <p class="text-gray-600 text-base">Perbarui informasi mata pelajaran di bawah ini.</p>
        </div>

        <form action="{{ route('academic.subjects.update', $subject) }}" method="POST" class="w-full">
            @csrf
            @method('PUT')
