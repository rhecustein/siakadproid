...
@section('content')
<div class="mb-6">
  <h2 class="text-2xl font-bold text-blue-700">Add New Subject</h2>
  <p class="text-sm text-gray-500">Fill in the form below to create a new subject.</p>
</div>

<form action="{{ route('academic.subjects.store') }}" method="POST" class="bg-white shadow rounded-xl p-6 space-y-6">
  @csrf
