...
<header class="bg-gradient-to-r from-blue-700 to-indigo-700 shadow-xl sticky top-0 z-50">
    <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        <div class="flex items-center gap-3">
            <img src="{{ asset('images/logo.png') }}" class="h-8 opacity-90 filter drop-shadow-md ai-logo-glow" alt="Logo">
            <h1 class="text-2xl font-extrabold text-white tracking-wide logo-glow-text">
                SIAKAD Al-Bahjah
            </h1>
        </div>
        <a href="{{ route('login') }}"
           class="text-sm font-semibold text-blue-700 bg-white hover:bg-blue-50 px-6 py-2.5 rounded-full shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            Masuk
        </a>
    </div>
</header>
...
<section class="relative overflow-hidden bg-gradient-to-br from-neutral-50 to-blue-50 text-neutral-800 py-32 lg:py-48 flex items-center justify-center min-h-[70vh]">
    ...
    <div class="relative z-20 max-w-5xl mx-auto text-center px-6">
        <img src="{{ asset('images/logo.png') }}" alt="Logo SIAKAD Al-Bahjah" class="w-40 mx-auto mb-6 drop-shadow-lg ai-logo-glow animate-fade-in"> {{-- Larger logo, AI glow --}}
        ...
        <div class="flex flex-wrap justify-center gap-x-8 gap-y-4 mb-12 text-lg text-gray-700 font-semibold">
            <div class="staggered-metric-item animate-fade-in-up animate-delay-400">50+ <span class="font-normal text-gray-500">Cabang Terintegrasi</span></div>
            <div class="staggered-metric-item animate-fade-in-up animate-delay-500">200+ <span class="font-normal text-gray-500">Sekolah Terpusat</span></div>
            <div class="staggered-metric-item animate-fade-in-up animate-delay-600">12.000+ <span class="font-normal text-gray-500">Pengguna Aktif</span></div>
            <div class="staggered-metric-item animate-fade-in-up animate-delay-700">AI Memproses <span class="font-normal text-gray-500">1 Juta+ Data/Hari</span></div>
        </div>


        <a href="{{ route('login') }}"
           class="inline-block bg-blue-600 text-white font-semibold px-8 py-4 rounded-full shadow-xl transition-all duration-300
                  hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300 animate-pulse-grow">
            Mulai Sekarang
...
<section class="py-24 bg-white text-gray-900">
    <div class="max-w-7xl mx-auto px-6 text-center">
        ...
        <div class="relative flex flex-col items-center justify-center space-y-12 lg:space-y-0 lg:flex-row lg:space-x-16">
            {{-- Source Nodes --}}
            ...
            {{-- Data Streams (Placeholder - would need more complex JS/SVG for true animated lines) --}}
            <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div class="w-1/2 h-0.5 bg-gray-300 transform -translate-x-1/4 relative data-stream-line"></div>
                <div class="w-0.5 h-1/2 bg-gray-300 transform -translate-y-1/4 relative data-stream-line vertical"></div>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            ...
            @foreach ($features as $feature)
                <div class="feature-card rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 transform hover:-translate-y-1">
                    <div class="h-40 flex items-center justify-center {{ $feature['gradient'] }} relative"> {{-- Added relative for badge positioning --}}
    ...
    <div class="max-w-4xl mx-auto px-6">
        ...
        <a href="{{ route('login') }}"
           class="inline-block bg-white text-blue-700 font-bold px-8 py-4 rounded-full shadow-xl transition-all duration-300
                  hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-white/50 animate-pulse-grow group">
            Gabung Sekarang
